...
impl PdfDocument {
    ...
    pub fn save_optimized<P: AsRef<Path>>(&mut self, path: P) -> Result<(), PdfError> {
        ...
        let trailer = self.xref_table.trailer_dict.clone().ok_or(PdfError::InvalidTrailer)?;
        ...
        new_trailer.insert("Size", crate::object::PdfObject::Integer(num_entries as i32));
    ...
    fn traverse_and_mark(&mut self, id: ObjectId, reachable: &mut HashSet<ObjectId>) -> Result<(), PdfError> {
    ...
    fn extract_references(&mut self, obj: &crate::object::PdfObject, reachable: &mut HashSet<ObjectId>) -> Result<(), PdfError> {
        match obj {
    ...
    pub fn parse_object_from_stream(&mut self, id: ObjectId) -> Result<crate::object::PdfObject, PdfError> {
...
trailer\n<< /Size 4 /Root 1 0 R >>\nstartxref\n138\n%%EOF").unwrap();
        ...
        doc.xref_table.entries.insert(1, crate::xref::XrefEntry::InUse { byte_offset: 9, generation_number: 0 });
        doc.xref_table.entries.insert(2, crate::xref::XrefEntry::InUse { byte_offset: 51, generation_number: 0 });
        doc.xref_table.entries.insert(3, crate::xref::XrefEntry::InUse { byte_offset: 89, generation_number: 0 });

        let mut trailer = crate::object::PdfDictionary::new();
        trailer.insert("Root", crate::object::PdfObject::Reference(ObjectId { object_number: 1, generation_number: 0 }));
