...
use pdf_engine_core::object::{ObjectId, PdfObject, PdfDictionary, PdfStream};
...
trailer\n<< /Size 5 /Root 1 0 R >>\nstartxref\n199\n%%EOF";
    ...
    doc.xref_table.entries.insert(2, XrefEntry::InUse { byte_offset: 51, generation_number: 0 });
    // Fix offset for object 3, '3 0 obj' is at index 88
    doc.xref_table.entries.insert(3, XrefEntry::InUse { byte_offset: 88, generation_number: 0 });
    // Fix offset for object 4, '4 0 obj' is at index 129
    doc.xref_table.entries.insert(4, XrefEntry::InUse { byte_offset: 129, generation_number: 0 });
    ...
    let _raw3 = doc.get_raw_object_bytes(ObjectId { object_number: 3, generation_number: 0 }).unwrap();
    ...
    doc.xref_table.entries.insert(1, XrefEntry::InUse { byte_offset: off1, generation_number: 0 });
    doc.xref_table.entries.insert(2, XrefEntry::InUse { byte_offset: off2, generation_number: 0 });
    doc.xref_table.entries.insert(3, XrefEntry::InUse { byte_offset: off3, generation_number: 0 });
    doc.xref_table.entries.insert(4, XrefEntry::InUse { byte_offset: off4, generation_number: 0 });
    ...
    doc.save_optimized(out_file.path()).expect("Failed to save optimized PDF");
}
